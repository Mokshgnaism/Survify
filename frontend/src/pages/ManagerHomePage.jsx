...
import { getMySurveys } from "../lib/api";
...
export default function ManagerHomePage() {
  ...
  const {
    ...
    queryFn: () => getMySurveys(searchText),
      ...
      >
        {loadingSurveys ? (
          ...
          <div className="col-span-full text-center text-gray-500 py-20">
            You donot have any current surveys...
          </div>
        ) : (
          surveys.map((survey) => (
            <motion.div
            ...
            >
              <Link to={`/surveyresult/${survey._id}`}>                
        ...
        <Link to = "/addsurvey">
          <div className="flex flex-col justify-center items-center">
            <button className="btn btn-primary gradient -r from bg-secondaryto bg-blue">
              Add Survey
            </button>
          </div>
        </Link>
